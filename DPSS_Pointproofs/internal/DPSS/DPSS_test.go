...
func TestReconstruct(t *testing.T) {
	...
	bls.SetFr(&newShares[0], "278831680007934705815643696909726099201621188031593024743160542064407474685")
	bls.SetFr(&newShares[1], "557663360015869411631287393819452198403242376063186049486321084128814937025")
	bls.SetFr(&newShares[2], "836495040023804117446931090729178297604863564094779074229481626193222399365")
	bls.SetFr(&newShares[3], "1115326720031738823262574787638904396806484752126372098972642168257629861705")

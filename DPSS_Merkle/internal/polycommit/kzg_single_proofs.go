...
import "github.com/opDPSSTeam/DPSS/internal/bls"
...
func (ks *KZGSettings) ComputeProofSingle(poly []bls.Fr, x bls.Fr) *bls.G1Point { //NOTE:Here we change "x uint64" to "x bls.Fr"
	// divisor = [-x, 1]
	divisor := [2]bls.Fr{}
	var tmp bls.Fr
	bls.CopyFr(&tmp, &x)
